Pod::Spec.new do |s|
  ...
  s.subspec "PaysafeCore" do |core|
    ...
    core.dependency "Paysafe/PaysafeCommon"
    core.dependency "Paysafe/PaysafeNetworking"
    core.dependency "Paysafe/Paysafe3DS"
    core.dependency "Paysafe/PaysafeApplePay"
    core.dependency "Paysafe/PaysafePayPal"
  end
